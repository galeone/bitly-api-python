...
class Connection(object):
    ...
    def shorten(self, uri, x_login=None, x_apiKey=None, preferred_domain=None):
        ...
        if x_login:
            params.update({'x_login': x_login, 'x_apiKey': x_apiKey})
    ...
    def referrers(self, hash=None, shortUrl=None):
        ...
        """
        warnings.warn(
            "/v3/referrers is depricated in favor of "
    ...
    def clicks_by_day(self, hash=None, shortUrl=None):
        ...
        warnings.warn(
            "/v3/clicks_by_day is depricated in favor of "
    ...
    def clicks_by_minute(self, hash=None, shortUrl=None):
        ...
        warnings.warn(
            "/v3/clicks_by_minute is depricated in favor of "
    ...
    def user_network_history(self,
                             offset=None,
                             expand_client_id=False,
                             limit=None,
                             expand_user=False):
        params = dict()
    ...
    def bundle_link_edit(self,
        ...
        if edit == "title":
            ...
            raise BitlyError(500, "PARAM EDIT MUST HAVE VALUE TITLE OR PREVIEW")
    ...
    def bundle_link_reorder(self, bundle_link, link, display_order):
        ...
        params = dict(
            bundle_link=bundle_link, link=link, display_order=display_order)
    ...
    def _call(self, host, method, params, secret=None, timeout=5000):
        ...
        request = "{scheme}://{host}/{method}?{params}".format(
            **{
                'scheme': scheme,
                'host': host,
                'method': method,
        ...
        try:
            print(request)
            http_response = bitly_http.get(
                request, timeout, user_agent=self.user_agent)
